...
export default function PrivacyPolicy() {
  return (
    <>
      <Head>
        <title>Privacy Policy - BrandBoosters</title>
        <meta name="description" content="BrandBoosters Privacy Policy" />
      </Head>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <section className="mb-12">
              ...
              <p className="mb-4">
                Welcome to BrandBoosters. We respect your privacy and are committed to protecting your personal data. 
            ...
            <section className="mb-12">
              ...
              <p className="mb-2">Email: info@brandboosters.marketing</p>
